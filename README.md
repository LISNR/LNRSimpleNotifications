...
1. Add __LNRSimpleNotifications__ to your Podfile. The current master branch supports Swift 2.2. Use the __swift3__ branch if you need Swift 3 by updating your Podfile to use this snippet: ```pod 'LNRSimpleNotifications', :git => 'https://github.com/LISNR/LNRSimpleNotifications.git', :branch => 'swift3'```
